...
class _TranslatePanelState extends State<TranslatePanel> {
  ...
  void initState() {
    ...
    PreferenceUtils.getString(
      ...
      _languages.first.length > 0 ? _languages.first[0] : _languages.first,
    ).then((value) {
      setState(() {
    ...
    subscriptions.add(
      NimCore.instance.aiService.onProxyAIModelCall.listen((event) {
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  margin: EdgeInsets.only(left: 12),
                  // height: 60,
                  constraints: BoxConstraints(maxHeight: 60, minHeight: 42),
