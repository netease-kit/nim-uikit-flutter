...
class ChatHistoryImageMessagePage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return ChatHistoryImageMessagePageState();
  }
}

class ChatHistoryImageMessagePageState
    extends BaseState<ChatHistoryImageMessagePage> {
  ...
  Widget _buildList() {
    ...
    return ListView.builder(
      ...
      reverse: true, // 让最新的分组显示在列表“顶部”（屏幕可见的首屏）
          ...
          children: [
            ...
            GridView.builder(
              ...
              itemBuilder: (context, msgIndex) {
                return _buildImageItem(messages[msgIndex]);
              },
            ),
          ],
        );
