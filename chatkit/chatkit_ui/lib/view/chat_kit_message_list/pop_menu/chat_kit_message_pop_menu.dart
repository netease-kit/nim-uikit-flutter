...
class ChatKitMessagePopMenu {
  ...
  _buildLongPressTipItem(
    ...
    final firstRowList = [
      ...
      if (config?.popMenuConfig?.enablePin != false && _enableStatus(message))
        {
          "label": _messageHavePined(message)
              ? S.of(context).chat_message_action_un_pin
              : S.of(context).chat_message_action_pin,
      ...
      //     _enableStatus(message))
      //   {
      //     "label": S.of(context).chat_message_action_multi_select,
      //     "id": multiSelectId,
      ...
      //     _enableStatus(message))
      //   {
      //     "label": S.of(context).chat_message_action_collect,
      //     "id": collectMessageId,
      //     "icon": "images/ic_chat_collect.svg"
      //   },
      if (config?.popMenuConfig?.enableDelete != false)
        {
          "label": S.of(context).chat_message_action_delete,
          "id": deleteMessageId,
      ...
      if (shouldShowRevokeAction &&
          ...
          _enableStatus(message))
        {
          "label": S.of(context).chat_message_action_revoke,
          "id": revokeMessageId,
