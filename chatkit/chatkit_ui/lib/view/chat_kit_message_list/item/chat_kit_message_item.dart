...
import 'package:chatkit_ui/view/chat_kit_message_list/helper/chat_message_helper.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/helper/chat_message_user_helper.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/item/chat_kit_message_audio_item.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/item/chat_kit_message_image_item.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/item/chat_kit_message_notify_item.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/item/chat_kit_message_tips_item.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/item/chat_kit_message_video_item.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/pop_menu/chat_kit_message_pop_menu.dart';
import 'package:chatkit_ui/view/chat_kit_message_list/pop_menu/chat_kit_pop_actions.dart';
import 'package:chatkit_ui/view/chat_message_ack_page.dart';
    ...
    if (message.nimMessage.status == NIMMessageStatus.sending) {
      ...
      return GestureDetector(
        ...
        child: SvgPicture.asset('images/ic_failed.svg',
            package: 'chatkit_ui', width: 16, height: 16),
      );
      ...
      return InkWell(
        ...
        child: ProgressRing(
          ...
          startImage:
              SvgPicture.asset('images/ic_unread.svg', package: 'chatkit_ui'),
          finishImage:
              SvgPicture.asset('images/ic_read.svg', package: 'chatkit_ui'),
        ),
      );
    } else {
      return Container();
