...
import 'package:chatkit_ui/view/input/emoji_panel.dart';
...
class _BottomInputFieldState extends State<BottomInputField>
    ...
    showBottomChoose<int>(
            ...
            actions: [
              CupertinoActionSheetAction(
                ...
                child: Text(
                  S.of(context).chat_message_pick_photo,
                  style: style,
                ),
              ),
              CupertinoActionSheetAction(
                ...
                child: Text(
                  S.of(context).chat_message_pick_video,
                  style: style,
                ),
              ),
            ],
  ...
  void _handleAitText(String value, List<UserInfoWithTeam>? member) {
    ...
    if (inputText.length > len) {
      ...
      showModalBottomSheet(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Align(
                          ...
                          child: Text(
                              S.of(context).chat_message_ait_contact_title))
                    ],
                  ),
                ),
                ListTile(
                  ...
                  title: Text(S.of(context).chat_team_ait_all),
                  onTap: () {
        ...
        if (select == 'all') {
          aitMemberMap['@${S.of(context).chat_team_ait_all}'] = null;
          inputController.text = "$value${S.of(context).chat_team_ait_all} ";
          inputText = inputController.text;
  ...
  _sendTextMessage() {
    ...
    if (text.isNotEmpty) {
      ...
      if (widget.sessionType == NIMSessionType.team) {
        pushList = [];
        if (aitMemberMap.containsKey('@${S.of(context).chat_team_ait_all}')) {
          // ait all
  ...
  onViewModelChange() {
    if (_viewModel.reeditMessage != null &&
        _viewModel.reeditMessage!.isNotEmpty) {
      _focusNode.requestFocus();
      inputController.text = _viewModel.reeditMessage!;
      inputController.selection = TextSelection.fromPosition(
          TextPosition(offset: _viewModel.reeditMessage!.length));
      inputText = inputController.text;
  ...
  Widget build(BuildContext context) {
    ...
    String? hint = mute ? S.of(context).chat_team_all_mute : widget.hint;
    return Container(
          ...
          children: [
                        ...
                        Expanded(
                          child: FutureBuilder<String>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Text(
                                S.of(context).chat_message_reply_someone(
                                    snapshot.data ?? ''),
                                maxLines: 1,
            ...
            _recording
                ? SizedBox(
                    height: 47,
                    child: Text(
                      S.of(context).chat_message_voice_in,
                      style: const TextStyle(
