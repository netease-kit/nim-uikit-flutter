...
typedef SusChanged = void Function();
...
class ContactAzListView extends StatefulWidget {
  ...
  @override
  createState() => _ContactAzListViewState();
}

class _ContactAzListViewState extends State<ContactAzListView> {
