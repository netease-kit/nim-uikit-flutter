...
import 'package:contactkit_ui/page/viewmodel/black_list_viewmodel.dart';
            ...
            child: Row(
              ...
              children: [
                Avatar(
                  ...
                  height: 36,
                  avatar: user.avatar,
                  name: contact?.getName() ?? user.userId,
                ...
                InkWell(
                  ...
                  child: Container(
                      ...
                      child: Text(S.of(context).contact_release,
                          style: TextStyle(
                            fontSize: 14,
      ...
      builder: (context, child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              S.of(context).contact_black_list,
              style: TextStyle(
                  fontSize: 16,
