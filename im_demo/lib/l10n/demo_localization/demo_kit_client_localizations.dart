...
abstract class DemoKitClientLocalizations {
  ...
  /// No description provided for @desktopWelcomeTitle.
  ///
  /// In en, this message translates to:
  /// **'Welcome to Netease CommsEase'**
  String get desktopWelcomeTitle;
  ...
  /// No description provided for @userInfoPhoneHint.
  ///
  /// In en, this message translates to:
  /// **'Enter phone number'**
  String get userInfoPhoneHint;

  /// No description provided for @userInfoEmailHint.
  ///
  /// In en, this message translates to:
  /// **'Enter email'**
  String get userInfoEmailHint;

  /// No description provided for @userInfoSignHint.
  ///
  /// In en, this message translates to:
  /// **'Enter signature'**
  String get userInfoSignHint;
